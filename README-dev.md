...
* Add some pins for parser recovery
  ...
  * [ ] Add more pins
  * [ ] Verify/test pins
* [x] Currently parser errors are hidden using highlightErrorFilter ✍️
...
✍️ There are no live templates for Dune.

📚 Both OCaml and Dune have Braces matching (hover the other).
...
📚 Dune also has a working structure view.
...
📚 We suggest the user to set the SDK if not set.
